...
const Welcomepage = () => {
    return (
        <section className="flex flex-col items-center self-stretch px-20 pt-72 pb-96 my-auto w-full text-2xl text-black bg-white rounded-xl shadow-[0px_4px_4px_rgba(0,0,0,0.25)] max-md:px-5 max-md:py-24 max-md:mt-6 max-md:max-w-full">
